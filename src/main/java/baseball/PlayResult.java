...
import static baseball.BaseBallGameConst.MAX_BALL_COUNT;
...
public class PlayResult {
  ...
  public String getResultString() {
    ...
    if (strikeResult > 0) {
      resultStrList.add(String.format("%d스트라이크", strikeResult));
    }
    if (ballResult > 0) {
      resultStrList.add(String.format("%d볼", ballResult));
    }
